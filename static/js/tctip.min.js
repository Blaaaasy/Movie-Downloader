var tctipUtil={createElement:function(param,tagName,target){
		...
		for(var key in param){
			...
			getElementsByClassName:function(className,node){
				...
				if(node.getElementsByClassName){
					...
					else{return(function getElementsByClass(searchClass,node){
							...
							if(pattern.test(els[i].className)){
								...
								getTextKey:function(){
									if(tctipUtil.getExplorer()=="firefox"){
										return"textContent"}return"innerText"},
